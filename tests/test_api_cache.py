...
class TestAPICache:
    ...
    def test_cache_initialization(self, temp_cache_dir):
        ...
        cache = APICache(cache_dir=temp_cache_dir, expire_seconds=3600, disable_cache=False)
    ...
    def test_cache_disabled(self, temp_cache_dir):
        ...
        cache = APICache(cache_dir=temp_cache_dir, expire_seconds=3600, disable_cache=True)
