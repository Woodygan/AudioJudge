...
def plot_verbosity_bias():
    ...
    bars1 = ax.bar(x - width/2, longer, width, label='Prefer Longer', 
                   color=colors['longer_pos1'], alpha=0.8, edgecolor='black', linewidth=0.5)
    bars2 = ax.bar(x + width/2, shorter, width, label='Prefer Shorter', 
                   color=colors['shorter_pos2'], alpha=0.8, edgecolor='black', linewidth=0.5)
    ...
    # Improve layout
    plt.tight_layout()
    plt.savefig('verbosity_bias.pdf', dpi=300, bbox_inches='tight', 
...
def plot_positional_bias_lexical():
    ...
    bars1 = ax.bar(x - width/2, pos1, width, label='Position 1 Bias', 
                   color=colors['longer_pos1'], alpha=0.8, edgecolor='black', linewidth=0.5)
    bars2 = ax.bar(x + width/2, pos2, width, label='Position 2 Bias', 
                   color=colors['shorter_pos2'], alpha=0.8, edgecolor='black', linewidth=0.5)
    ...
    plt.tight_layout()
    plt.savefig('positional_bias_lexical.pdf', dpi=300, bbox_inches='tight', 
                facecolor='white', edgecolor='none')
    plt.show()
...
def plot_positional_bias_nonlexical():
    ...
    plt.tight_layout()
    plt.savefig('positional_bias_nonlexical.pdf', dpi=300, bbox_inches='tight', 
                facecolor='white', edgecolor='none')
    plt.show()
...
def create_all_bias_plots():
    ...
    print("✓ Positional bias (non-lexical) plot saved as 'positional_bias_nonlexical.pdf'")
